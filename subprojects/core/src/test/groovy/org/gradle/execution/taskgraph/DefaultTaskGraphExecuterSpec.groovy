...
class DefaultTaskGraphExecuterSpec extends Specification {
    ...
    def taskExecuter = new DefaultTaskGraphExecuter(listenerManager, new DefaultTaskPlanExecutor(1, executorFactory, workerManagementService), Factories.constant(executer), cancellationToken, buildOperationExecutor, workerManagementService)
