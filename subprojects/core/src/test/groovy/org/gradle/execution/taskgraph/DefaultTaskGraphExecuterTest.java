...
public class DefaultTaskGraphExecuterTest {
    ...
    public void setUp() {
        ...
        taskExecuter = new DefaultTaskGraphExecuter(listenerManager, new DefaultTaskPlanExecutor(1, executorFactory, workerManagementService), Factories.constant(executer), cancellationToken, buildOperationExecutor, workerManagementService);
    }
