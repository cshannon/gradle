...
class MavenMetadataSnapshotsLoader {
    private static final Logger LOGGER = LoggerFactory.getLogger(MavenMetadataSnapshotsLoader.class);

    public MavenMetadataSnapshots load(URI metadataLocation) throws ResourceException {
    	MavenMetadataSnapshots metadata = new MavenMetadataSnapshots();
        try {
    ...
    private void parseMavenMetadataInfo(final URI metadataLocation, final MavenMetadataSnapshots metadata) throws IOException {
...
//        }
    ...
    private void parseMavenMetadataInto(ExternalResource metadataResource, final MavenMetadataSnapshots mavenMetadata) {
